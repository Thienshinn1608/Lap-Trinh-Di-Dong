...
//           Expanded(
//             child: Container(
//               color: const Color.fromARGB(255, 245, 245, 245), // Màu nền tổng thể
//               padding: const EdgeInsets.all(4),
//               child: GridView.count(
//                 crossAxisCount: 4,
//                 childAspectRatio: 1.25, // Kéo dãn nhẹ để nút không bị quá cao
//                 children: [
//                   calcButton("%"), calcButton("CE"), calcButton("C"), calcButton("⌫"),
...
//                        text == "÷" || text == "%" || text == "1/x" || text == "x²" || 
//                        text == "²√x" || text == "+/-") {
//               // Các phím phép tính tạm thời chỉ in ra log (đợi viết logic toán học sau)
